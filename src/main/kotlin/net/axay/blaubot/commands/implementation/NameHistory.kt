...
object GithubProfile : SlashCommand(
    "githubprofile",
    "Shows you the Minecraft name history of a given user",
    {
    ...
    override suspend fun execute(interaction: CommandInteraction, command: InteractionCommand) {
        interaction.acknowledgePublic().followUp {
            embed {
                ...
                title = user
                description = "This is the Minecraft name history of $user"
                image = "https://files.vollkorn.me/TaitoNameHistory/?user=$user"
            }
        }
    }
}
